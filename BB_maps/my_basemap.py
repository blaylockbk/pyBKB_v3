...
def draw_centermap(center, size=(3, 3), resolution="i", area_thresh=2000):
    ...
    return Basemap(
        ...
        llcrnrlon=lon - size[1],
        llcrnrlat=lat - size[0],
        urcrnrlon=lon + size[1],
        urcrnrlat=lat + size[0],
    )
...
def draw_HRRR_map(resolution="i", area_thresh=2000):
    ...
    """
    FILE = (
        "/uufs/chpc.utah.edu/common/home/u0553130/pyBKB_v3/BB_maps/saved_map_objects/HRRR_lcc_%s_%s.npy"
...
def draw_GOES_East_geo(resolution="i", area_thresh=3000):
    ...
    """
    print(
        "WARNING: you will get better lines if you plot with Cartopy."
        "See this: https://github.com/blaylockbk/pyBKB_v3/issues/1"
    )
    return Basemap(
        projection="geos",
