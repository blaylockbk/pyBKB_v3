...
def graph_this(DATE):
    img_name = SAVEDIR + "HRRR_RMSD-%s_%s" % (
...
for variable in [
    ...
    SAVEDIR = (
        "/uufs/chpc.utah.edu/common/home/u0553130/public_html/PhD/HRRR_RMSE/TimeSeries/%s/"
        % variable.split(":")[0]
    )
