...
def get_spex():
    ...
    spex = {
        ...
        "Simulated Reflectivity": {
            "HRRR var": "REFC:entire atmosphere",
            "MW var": "reflectivity",
...
def plot_hov(sDATE, eDATE, variable_number, stations, save=True):
    ...
    hovmoller = LocDic_hrrr_hovmoller(
        sDATE, eDATE, locations, spex[variable]["HRRR var"]
    )
    ...
    for i, stn in enumerate(stations):
        ...
        cb = plt.colorbar(
            ...
            pad=0.01,
            shrink=0.8,
            label="%s (%s)" % (variable, spex[variable]["units"]),
        )
