...
def LU_MODIS21():
    C = np.array(
        [
            ...
            [0.82, 0.41, 0.12],  # 7 Open Shrublands
...
def LU_MODIS20():
    ...
    return {"cmap": cm, "labels": labels, "vmin": 1, "vmax": len(labels) + 1}
